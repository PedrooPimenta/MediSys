...
def send_email(profile):
     ...
     try:
         ...
         send_mail(subject="Recuperação de senha", message=message, html_message=message, from_email=settings.EMAIL_HOST_USER, recipient_list=[profile.user.email], fail_silently=False)
     except:
         raise Exception
